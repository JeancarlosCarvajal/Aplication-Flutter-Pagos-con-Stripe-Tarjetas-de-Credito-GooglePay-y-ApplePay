...
class PaymentIntentResponse {
    PaymentIntentResponse({
        ...
        object = object ?? '{}', 
        amount = amount ?? 0, 
        amountCapturable = amountCapturable ?? 0, 
        amountDetails = amountDetails ?? AmountDetails(tip: Metadata()), 
        amountReceived = amountReceived ?? 0, 
        captureMethod = captureMethod ?? '', 
        charges = charges ?? Charges(object: '', data: [], hasMore: false, totalCount: 0, url: ''), 
